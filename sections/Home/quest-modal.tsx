    ...
    return (
        ...
        >
            <View style={styles.modalContainer}>
                ...
                <ScrollView style={[styles.modalContent, { backgroundColor: colorScheme === 'dark' ? '#1a1a1a' : '#fff' }]}
                >
                    ...
                    <View style={styles.badgeContainer}>
                        <View style={[styles.badge, { backgroundColor: getDifficultyColor(quest.difficulty) }]}>
                            <ThemedText type='caption' style={styles.badgeText}>{quest.difficulty.toUpperCase()}</ThemedText>
                        </View>
                        <View style={styles.badge}>
                            <ThemedText type='caption' style={styles.badgeText}>{quest.category}</ThemedText>
                        </View>
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={onClose}
                    >
                        <ThemedText type="body" style={styles.closeButtonText}>Close</ThemedText>
                    </TouchableOpacity>
