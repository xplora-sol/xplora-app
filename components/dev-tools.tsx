...
export function DevTools() {
    ...
    return (
        <ThemedView style={styles.container}>
            <ThemedText type="defaultSemiBold" style={styles.title}>Dev Tools</ThemedText>
            <TouchableOpacity style={styles.button} onPress={handleReset}>
                <ThemedText type="defaultSemiBold" style={styles.buttonText}>Reset Progress</ThemedText>
            </TouchableOpacity>
        </ThemedView>
    );
}
